	...
	public POSSale(JFrame currentFrame, StoreService storeService, Session session, Sale sale) {
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				currentFrame.getContentPane().add(new POSSale(currentFrame, storeService, session, new Sale()));
		...
		btnPayments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				currentFrame.getContentPane()
						.add(new POSPayment(currentFrame, currentPanel, storeService, session, sale));
				currentFrame.getContentPane().revalidate();
			}
		});
		...
		btnEndSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				storeService.getStore().addSession(session);
				currentFrame.getContentPane().removeAll();
				currentFrame.getContentPane().add(new POSEndSessionPanel(currentFrame, storeService, session));
				currentFrame.getContentPane().revalidate();
			}
		});

...
/** Lists cashiers with add/edit/delete actions. */
public class CashierListPanel extends JPanel {
    ...
    /** Create the panel. */
    public CashierListPanel(JFrame currentFrame, StoreService storeService) {
                ...
                new ListSelectionListener() {
                    public void valueChanged(ListSelectionEvent e) {
                        ...
                        if (selected != null) {
                            ...
                            // A cashier that has worked sessions cannot be deleted.
                            btnDelete.setEnabled(!selected.isUsed());
                        } else {
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        currentFrame
                                ...
                                .add(
                                        new CashierEditPanel(
                                                currentFrame, storeService, new Cashier(), true));
                        currentFrame.getContentPane().revalidate();
                    }
                });

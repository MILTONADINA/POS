...
public class ItemEditPanel extends JPanel {
    ...
    public ItemEditPanel(
            JFrame currentFrame, POSPD.StoreService storeService, Item item, Boolean isAdd) {
        ...
        btnSave.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        currentFrame
                                .getContentPane()
                                .add(new ItemListPanel(currentFrame, storeService));
                ...
                new ListSelectionListener() {
                    public void valueChanged(ListSelectionEvent e) {
                        if (list_1.getSelectedValue() != null) {
                            if (list_1.getSelectedValue() != null) btnEdit_1.setEnabled(true);
                            if (!list_1.getSelectedValue().isUsed()) btnDelete_1.setEnabled(true);
                        } else {

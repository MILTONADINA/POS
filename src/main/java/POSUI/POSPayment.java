...
public class POSPayment extends JPanel {
	 ...
	 * Create the panel.
	 */
	public POSPayment(JFrame currentFrame, JPanel salePanel, StoreService storeService, Session session, Sale sale) {
		...
		btnCash.addActionListener(new ActionListener() // AC
		{
			public void actionPerformed(ActionEvent e) {
				cashPanel = new CashPanel(currentFrame, thisPanel, storeService.getStore(), session, sale, new Cash());
		...
		btnCheck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				checkPanel = new CheckPanel(currentFrame, thisPanel, storeService.getStore(), session, sale,
						new Check());
		...
		btnCredit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				creditPanel = new CreditPanel(currentFrame, thisPanel, storeService.getStore(), session, sale,
						new Credit());
